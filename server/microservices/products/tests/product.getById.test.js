...
describe('GET /api/product/:id', () => {
    ...
    it('returns product when found', async () => {
        ...
        expect(res.body.product).toHaveProperty('_id', doc._id.toString());
        expect(res.body.product).toHaveProperty('name', doc.name);
    });
    ...
    it('handles repository/service errors (500)', async () => {
        ...
        expect(['FETCH_PRODUCT_FAILED', 'FETCH_PRODUCT_ERROR', 'INTERNAL_ERROR']).toContain(res.body.code);
    });
});
